...
Há tendência natural à autonomia e à liderança no campo material. A pessoa sente necessidade de agir, construir e abrir caminhos próprios.

O principal aprendizado envolve desenvolver constância, paciência e continuidade, garantindo que a forte iniciativa produza resultados duradouros.`,

2:`A energia física manifesta-se de forma cooperativa, constante e equilibrada. Existe grande capacidade de trabalhar em parceria, construir em equipe e sustentar projetos com estabilidade.

A ação prática tende a acontecer com sensibilidade ao ambiente e às pessoas ao redor, favorecendo relações harmoniosas e produtivas.

O desafio está em manter a autonomia e não depender excessivamente da validação externa para agir.`,

3:`A energia física é dinâmica, versátil e produtiva. Existe facilidade natural para iniciar atividades, executar tarefas e manter ritmo ativo ao longo da vida.

A ação costuma ser acompanhada de entusiasmo e criatividade, tornando a produtividade mais leve e espontânea.

O principal cuidado é evitar dispersão e direcionar o dinamismo para objetivos consistentes e duradouros.`,

4:`Existe forte capacidade de disciplina, organização e construção material. A energia física favorece rotina, constância e perseverança.

Projetos tendem a ser desenvolvidos com método, planejamento e senso de responsabilidade, permitindo resultados sólidos ao longo do tempo.

O desafio consiste em equilibrar rigidez com flexibilidade, evitando excesso de controle ou sobrecarga.`,

5:`A energia física manifesta-se com grande vitalidade, movimento e adaptabilidade. Existe forte impulso para agir, explorar e experimentar novas possibilidades.

Mudanças e desafios estimulam a ação e aumentam a produtividade, favorecendo crescimento através da experiência.

O principal aprendizado envolve desenvolver foco e continuidade para transformar movimento em realização concreta.`,

6:`Existe forte disposição para assumir responsabilidades e cuidar da vida prática. A energia física favorece estabilidade, compromisso e senso de dever.

A ação costuma ser direcionada à construção de segurança, harmonia e bem-estar material.

O desafio está em evitar sobrecarga e aprender a equilibrar responsabilidades com autocuidado.`,

7:`A energia física manifesta-se com direção, propósito e seletividade. Existe capacidade de agir com estratégia, foco e profundidade.

A ação tende a acontecer quando há significado, objetivo claro ou necessidade de compreensão mais profunda da realidade.

O principal aprendizado envolve manter equilíbrio entre ação e recolhimento, evitando isolamento excessivo.`,

8:`Existe forte capacidade de realização material, produtividade e foco em resultados. A energia física favorece liderança, metas e conquistas concretas.

Projetos tendem a ser conduzidos com determinação, persistência e visão prática.

O desafio consiste em equilibrar ambição com bem-estar e qualidade de vida.`,

9:`A energia física manifesta-se com grande impulso de realização voltado a propósitos amplos. Existe disposição para agir em projetos que tragam contribuição coletiva ou impacto positivo.

A ação costuma ser guiada por ideais, valores e senso de missão.

O principal aprendizado envolve equilibrar idealismo com praticidade e constância.`
...
A constância pode variar conforme o entusiasmo e o interesse pelo que está sendo feito. Quando existe propósito, a disposição cresce naturalmente; quando não há, a energia pode oscilar.

Equilibrar iniciativa com disciplina e continuidade permite transformar potencial de ação em resultados sólidos e consistentes.`,

2:`A ação prática tende a acontecer de forma cooperativa e equilibrada. Existe boa capacidade de trabalhar em parceria e construir resultados de maneira gradual e constante.

A iniciativa pode surgir com mais facilidade quando existe apoio, harmonia e segurança no ambiente. A energia física responde melhor a contextos colaborativos do que competitivos.

Fortalecer a autonomia nas decisões práticas contribui para ampliar a confiança e a independência nas ações.`,

3:`A energia física manifesta-se de forma dinâmica e versátil. Existe facilidade para iniciar atividades e movimentar projetos, especialmente quando há entusiasmo e criatividade envolvidos.

A constância pode depender do interesse e da variedade das tarefas. Rotinas muito repetitivas podem reduzir a motivação ao longo do tempo.

Organizar prioridades e manter foco nos objetivos ajuda a transformar dinamismo em produtividade contínua.`,

4:`Existe boa capacidade de organização e construção material quando há disciplina e planejamento. A energia física responde bem a rotinas estruturadas e objetivos claros.

A produtividade tende a crescer quando existe método e constância. A disposição prática pode aumentar à medida que hábitos estáveis são desenvolvidos.

Equilibrar disciplina com flexibilidade permite crescimento sólido sem rigidez excessiva.`,

5:`A energia física é adaptável e responde bem a mudanças e novos estímulos. Existe facilidade para agir quando surgem oportunidades ou desafios.

A constância pode variar conforme o ritmo de novidades e experiências. Ambientes dinâmicos estimulam a ação e a produtividade.

Criar estabilidade e manter continuidade nas metas ajuda a transformar movimento em realização concreta.`,

6:`Existe boa disposição para assumir responsabilidades e cuidar de tarefas práticas do dia a dia. A energia física responde bem a compromissos e deveres.

A produtividade cresce quando existe senso de utilidade e contribuição. O equilíbrio entre trabalho e bem-estar torna-se essencial.

Aprender a dividir responsabilidades evita sobrecarga e mantém a energia sustentável.`,

7:`A ação prática tende a ser seletiva e direcionada. Existe disposição para agir quando há propósito, significado ou interesse genuíno.

A energia física pode alternar entre períodos de atividade e momentos de recolhimento. Esse ritmo faz parte do equilíbrio natural.

Respeitar o próprio tempo, mantendo constância nas metas, favorece resultados consistentes.`,

8:`Existe boa capacidade de realização material e foco em objetivos concretos. A energia física responde bem a metas, resultados e desafios.

A produtividade cresce quando há clareza de propósito e metas definidas. A persistência tende a se desenvolver ao longo da experiência.

Equilibrar ambição com bem-estar garante crescimento sustentável.`,

9:`A energia física tende a direcionar-se para projetos amplos e objetivos de maior significado. Existe disposição para agir quando há propósito e contribuição coletiva.

A constância pode depender da conexão com valores pessoais e ideais. Quando há propósito, a energia cresce naturalmente.

Transformar visão em ação prática fortalece a capacidade de realização material.`
...
A relação com o corpo e com a vitalidade pede atenção especial. Pode haver sensação de pouca energia, cansaço frequente ou dificuldade em manter constância em rotinas físicas e produtivas. A disciplina, a organização e a construção de hábitos tornam-se aprendizados essenciais para desenvolver estabilidade e continuidade nas realizações materiais.`,
1:`Existe uma tendência natural a viver mais no campo das ideias do que na ação concreta, o que pode fazer com que muitas iniciativas permaneçam apenas no plano da intenção. A energia física pode oscilar ao longo da vida, dificultando a constância necessária para iniciar e sustentar projetos materiais com regularidade.

O impulso de começar coisas existe, mas frequentemente falta disposição prática para transformar esse impulso em movimento contínuo. Pode haver períodos de grande motivação seguidos por fases de queda de energia ou procrastinação, criando a sensação de começar muito e concluir pouco.

A relação com o corpo e com a rotina tende a exigir atenção especial. Existe a possibilidade de sensibilidade física maior ou predisposição a cansaço, o que pode interferir na produtividade e na disciplina diária.

Aprender a respeitar os próprios limites físicos, organizar a rotina e desenvolver hábitos consistentes torna-se fundamental para que o potencial de iniciativa se manifeste de forma concreta e sustentável ao longo da vida.`,
2:`Existe tendência a evitar confrontos materiais e situações que exijam esforço físico constante ou decisões práticas firmes. A ação pode surgir com hesitação, principalmente quando envolve assumir responsabilidades concretas ou lidar com exigências do cotidiano.

A iniciativa costuma depender do apoio de outras pessoas ou de ambientes que ofereçam segurança e estabilidade. A autonomia material pode demorar mais a se desenvolver, surgindo gradualmente com a experiência.

Pode haver sensibilidade física maior, exigindo ritmo mais equilibrado e respeito aos limites do corpo. Construir autoconfiança prática e fortalecer a independência nas ações torna-se um aprendizado importante ao longo da vida.`,

3:`A energia física tende a dispersar-se com facilidade, dificultando a constância necessária para manter rotinas e projetos materiais. A motivação para iniciar atividades pode surgir rapidamente, mas a continuidade pode oscilar ao longo do tempo.

Existe tendência a buscar variedade e estímulos, o que pode tornar repetição e disciplina tarefas mais desafiadoras. Projetos podem começar com entusiasmo e perder força antes da conclusão.

Organização, foco e criação de hábitos consistentes tornam-se fundamentais para transformar criatividade e iniciativa em resultados concretos e duradouros.`,

4:`A estrutura, a disciplina e a rotina podem exigir esforço consciente para se desenvolver. A organização prática não surge de forma automática, podendo haver dificuldade em manter constância nas tarefas do dia a dia.

Projetos que exigem método, persistência e repetição podem parecer pesados ou cansativos. Existe tendência a adiar responsabilidades práticas quando elas exigem esforço prolongado.

Criar rotinas estáveis, desenvolver disciplina e fortalecer a capacidade de persistir tornam-se aprendizados essenciais para construir segurança material ao longo da vida.`,

5:`A energia física pode oscilar bastante, alternando períodos de atividade com fases de pouca disposição. A constância em hábitos e rotinas tende a ser desafiadora, especialmente quando há necessidade de repetição.

Pode haver dificuldade em manter ritmo estável de trabalho ou disciplina prolongada. A motivação costuma depender de estímulos externos ou mudanças de ambiente.

Aprender a criar estabilidade, ritmo e continuidade nas ações torna-se essencial para transformar movimento em resultados concretos.`,

6:`As responsabilidades práticas podem ser sentidas como exigentes ou pesadas. Assumir compromissos materiais constantes pode gerar sensação de sobrecarga ou cansaço.

Pode existir tendência a priorizar outras áreas da vida antes das tarefas práticas, deixando obrigações materiais para depois. A constância em responsabilidades exige esforço consciente.

Desenvolver senso de compromisso, organização doméstica e equilíbrio entre dever e bem-estar torna-se um aprendizado importante.`,

7:`A energia física pode voltar-se mais para o interior do que para a ação externa. Existe tendência a preferir atividades mais tranquilas, reservadas ou individuais.

A motivação para agir materialmente pode surgir apenas quando há propósito claro ou significado pessoal. Rotinas muito exigentes fisicamente podem gerar desgaste.

Respeitar o próprio ritmo, fortalecer o corpo gradualmente e criar hábitos consistentes tornam-se passos importantes para manter equilíbrio entre ação e introspecção.`,

8:`Questões ligadas a poder material, ambição e conquistas práticas podem não surgir como prioridade natural. A busca por resultados concretos pode acontecer de forma lenta ou gradual.

Pode haver dificuldade em manter foco em metas materiais de longo prazo ou em lidar com pressões relacionadas a produtividade e desempenho.

Desenvolver confiança na própria capacidade de realização e fortalecer a persistência nas metas torna-se essencial para construir segurança material.`,

9:`A energia física pode direcionar-se mais para o campo das ideias ou dos ideais do que para a execução prática. Existe tendência a dispersar a ação em muitas direções, dificultando a conclusão de projetos materiais.

Pode haver dificuldade em manter constância e foco em objetivos concretos de longo prazo. A motivação surge quando existe propósito claro, mas pode faltar continuidade.

Aprender a transformar inspiração em ação prática e desenvolver disciplina para concluir projetos torna-se um aprendizado importante ao longo da vida.`
    }
  },
...
2:`A mente possui forte capacidade de perceber nuances, compreender pessoas e analisar situações sob múltiplas perspectivas. Existe grande habilidade para mediação, diplomacia e leitura emocional dos ambientes.

A tendência é refletir profundamente antes de agir, valorizando harmonia e cooperação. O desafio está em evitar indecisão causada pelo excesso de análise ou pela necessidade de agradar a todos.`,

3:`A mente é altamente criativa, comunicativa e expressiva. Existe facilidade natural para aprender, ensinar, explicar e transmitir ideias com clareza e entusiasmo.

O pensamento é dinâmico e fértil, podendo gerar muitas ideias simultaneamente. O desafio está em desenvolver foco e continuidade para transformar inspiração em realização concreta.`,

4:`A mente é estruturada, lógica e extremamente organizada. Existe forte capacidade de planejamento, disciplina intelectual e construção de raciocínios sólidos.

A pessoa tende a pensar de forma estratégica e sistemática. O desafio está em evitar rigidez mental, excesso de controle ou resistência a mudanças inesperadas.`,

5:`A mente é inquieta, curiosa e altamente adaptável. Existe grande necessidade de estímulo intelectual, aprendizado constante e contato com novas ideias.

A rapidez de pensamento favorece soluções criativas e flexibilidade mental. O desafio está em evitar dispersão, ansiedade mental ou excesso de estímulos simultâneos.`,

6:`A mente é profundamente responsável, cuidadosa e orientada ao bem-estar coletivo. Existe forte tendência a refletir sobre consequências, deveres e responsabilidades.

A pessoa costuma pensar antes de agir e buscar equilíbrio nas decisões. O desafio está em evitar excesso de preocupação, cobrança mental ou autocriticismo.`,

7:`A mente é investigativa, analítica e profundamente reflexiva. Existe forte busca por conhecimento, significado e compreensão da realidade.

A pessoa tende a questionar, estudar e analisar profundamente tudo ao redor. O desafio está em evitar isolamento mental, excesso de introspecção ou distanciamento da realidade prática.`,

8:`A mente é estratégica, objetiva e voltada para realização. Existe grande capacidade de planejamento, visão de longo prazo e tomada de decisões.

O pensamento é orientado a resultados e eficiência. O desafio está em equilibrar racionalidade com sensibilidade e evitar excesso de controle.`,

9:`A mente possui visão ampla, humanitária e abrangente. Existe forte capacidade de compreender contextos coletivos e refletir sobre questões maiores da vida.
...
2:`Existe uma capacidade natural de reflexão e análise que permite compreender diferentes pontos de vista com relativa facilidade. A mente tende a buscar equilíbrio e cooperação, favorecendo o diálogo, a diplomacia e a capacidade de mediação.

A tomada de decisões costuma envolver avaliação cuidadosa das situações, evitando impulsividade. O desafio principal está em confiar mais na própria opinião e reduzir a tendência a depender excessivamente da validação externa.`,

3:`A mente possui dinamismo e criatividade moderados, favorecendo a comunicação, a expressão de ideias e a troca intelectual. Existe facilidade para aprender, explicar e organizar pensamentos de forma clara.

Em alguns momentos pode surgir dispersão ou excesso de estímulos mentais, sendo importante desenvolver foco e continuidade para transformar ideias em resultados consistentes.`,

4:`Existe uma estrutura mental organizada e prática, voltada para lógica, planejamento e construção de ideias sólidas. A pessoa tende a pensar de forma metódica e buscar segurança nas decisões.

O desafio está em evitar rigidez mental ou resistência a mudanças, permitindo maior flexibilidade e abertura para novas possibilidades.`,

5:`A mente demonstra curiosidade e adaptabilidade, favorecendo aprendizado constante e interesse por novidades. Existe facilidade para absorver informações e se adaptar a diferentes contextos.

Pode surgir inquietação mental ou dificuldade em manter foco prolongado, sendo importante desenvolver disciplina intelectual e constância.`,

6:`Existe uma mente voltada para responsabilidade, cuidado e compreensão das necessidades dos outros. A pessoa tende a refletir antes de agir e buscar soluções equilibradas.

O desafio pode ser evitar excesso de preocupação ou responsabilidade mental, aprendendo a equilibrar razão e leveza.`,

7:`A mente possui inclinação natural para introspecção, análise profunda e busca de conhecimento. Existe interesse por compreender o significado das coisas e investigar a realidade de forma mais profunda.

Pode surgir tendência ao isolamento mental ou excesso de questionamento, sendo importante equilibrar reflexão com ação.`,

8:`Existe uma mente estratégica e objetiva, voltada para resultados e realização. A pessoa tende a pensar de forma prática, buscando eficiência e planejamento.

O desafio está em equilibrar ambição com sensibilidade, evitando rigidez ou excesso de controle mental.`,

9:`A mente demonstra visão ampla e capacidade de compreender o coletivo. Existe facilidade para enxergar contextos maiores e refletir sobre questões humanas e sociais.
...
Pode existir menor interesse por planejamento detalhado ou por atividades que exijam esforço intelectual prolongado. A mente tende a funcionar de forma mais simples e direta, aprendendo melhor pela experiência prática do que pela teoria. Desenvolver foco, organização mental e clareza de raciocínio torna-se um aprendizado importante ao longo da vida.`,

1:`Existe tendência a agir mais pela experiência direta do que pelo planejamento mental. Ideias surgem, mas nem sempre são organizadas ou estruturadas antes da ação.

Pode haver dificuldade em manter foco prolongado, estudar por longos períodos ou estruturar estratégias detalhadas. A mente prefere soluções simples e imediatas.

O desenvolvimento acontece quando a pessoa aprende a planejar antes de agir e a organizar pensamentos com mais método.`,

2:`A atividade mental tende a ser mais prática do que analítica. Existe preferência por aprender fazendo, em vez de estudar teorias extensas.

Pode haver dificuldade em organizar ideias com clareza ou tomar decisões baseadas apenas em raciocínio lógico.

O crescimento mental acontece quando se desenvolve o hábito de refletir antes de decidir e estruturar melhor as informações.`,

3:`A mente pode funcionar de forma espontânea e pouco estruturada. Existe facilidade para pensar rapidamente, mas dificuldade em manter disciplina intelectual.

Estudos longos, planejamento detalhado e organização mental podem exigir esforço extra.

O aprendizado envolve criar hábitos de estudo, foco e organização das ideias.`,

4:`Existe tendência a evitar excesso de planejamento ou análise detalhada. A mente pode preferir resolver situações conforme surgem.

Organização, método e disciplina intelectual precisam ser desenvolvidos ao longo da vida.

O progresso mental acontece quando a pessoa aprende a estruturar pensamentos e criar rotinas de planejamento.`,

5:`A mente tende a buscar estímulos rápidos e variados, podendo ter dificuldade em manter concentração por longos períodos.

Existe facilidade para mudar de assunto ou interesse, mas desafio para aprofundar conhecimentos.

O desenvolvimento ocorre quando se aprende a manter foco e concluir processos mentais iniciados.`,

6:`Existe tendência a pensar de forma prática, porém sem aprofundar muito as análises. Decisões podem ser tomadas sem reflexão suficiente.

Planejamento mental e organização de prioridades podem exigir esforço consciente.

O crescimento acontece quando se desenvolve disciplina intelectual e capacidade de análise.`,

7:`A mente pode apresentar dificuldade em manter concentração profunda ou estudo prolongado. Existe preferência por soluções diretas e imediatas.

Processos que exigem investigação ou análise detalhada podem parecer cansativos.

O desenvolvimento ocorre ao cultivar foco, paciência e hábito de reflexão.`,

8:`Pode haver dificuldade em estruturar metas mentais claras ou estratégias de longo prazo. O pensamento tende a ser mais reativo do que planejado.

Organização intelectual e definição de objetivos precisam ser desenvolvidas.

O crescimento mental acontece ao aprender a planejar, definir metas e estruturar decisões.`,

9:`A mente pode ter dificuldade em organizar ideias amplas ou pensar em longo prazo. Existe tendência a focar no imediato.

Visão estratégica e planejamento global precisam ser desenvolvidos com o tempo.

O aprendizado ocorre ao ampliar a visão mental e estruturar pensamentos com mais clareza.`
}
  },
...
3:`Expressividade emocional marcante. Sentimentos são comunicados com naturalidade, criatividade e espontaneidade, tornando a pessoa emocionalmente acessível e envolvente.`,

4:`Estabilidade emocional sólida. Existe capacidade de construir relações duradouras, seguras e baseadas em confiança, demonstrando lealdade e constância afetiva.`,

5:`Emoções intensas e dinâmicas. Existe forte necessidade de viver experiências afetivas variadas, com abertura para mudanças e novas conexões emocionais.`,

6:`Profundo senso de cuidado e responsabilidade emocional. Forte capacidade de amar, proteger e criar ambientes afetivos harmoniosos.`,

7:`Emoções profundas e sensibilidade refinada. Existe forte vida emocional interior, com capacidade de compreender sentimentos complexos e buscar significado nas experiências afetivas.`,

8:`Intensidade emocional associada à força e proteção. Capacidade de sustentar emocionalmente outras pessoas e enfrentar desafios afetivos com firmeza.`,
...
3:`A expressão emocional tende a ser espontânea e comunicativa. A pessoa costuma demonstrar sentimentos com naturalidade, mantendo leveza e abertura nas relações.`,

4:`Existe estabilidade emocional e tendência a buscar segurança nos vínculos. A pessoa costuma lidar com sentimentos de forma prática e consistente, valorizando relações duradouras.`,

5:`Há flexibilidade emocional e facilidade em lidar com mudanças afetivas. A pessoa consegue equilibrar liberdade emocional com envolvimento, adaptando-se bem às situações.`,

6:`Existe forte senso de responsabilidade emocional e capacidade de cuidar dos vínculos afetivos. A pessoa tende a valorizar harmonia, família e relações estáveis.`,

7:`Há profundidade emocional equilibrada com introspecção saudável. A pessoa costuma refletir sobre sentimentos sem se isolar excessivamente, mantendo equilíbrio entre interior e exterior.`,

8:`Existe controle emocional aliado à maturidade afetiva. A pessoa tende a lidar com sentimentos de forma firme e consciente, mantendo estabilidade nas relações.`,
...
A sensibilidade afetiva pode funcionar em segundo plano, o que pode gerar certa distância emocional ou dificuldade em reconhecer e nomear sentimentos com clareza. Desenvolver conexão com as próprias emoções e aprender a expressá-las torna-se um processo importante de crescimento pessoal.`,

1:`Existe tendência a reprimir emoções e evitar demonstrar vulnerabilidade. Pode haver dificuldade em reconhecer os próprios sentimentos, preferindo agir de forma racional ou distante. Isso pode gerar bloqueios emocionais e sensação de isolamento afetivo.`,
...
3:`Intuição criativa e inspirada. Ideias surgem com facilidade e espontaneidade, trazendo insights originais e soluções inesperadas.`,

4:`Intuição prática e confiável. Existe capacidade de prever consequências, organizar decisões e estruturar ações com base em percepções antecipadas.`,

5:`Intuição dinâmica e adaptável. Facilidade para perceber mudanças, oportunidades e riscos antes que se tornem evidentes.`,

6:`Intuição protetora e cuidadora. Forte capacidade de pressentir necessidades dos outros e agir preventivamente em favor do bem-estar coletivo.`,

7:`Intuição profunda e investigativa. Forte conexão com o mundo interior, percepção espiritual e busca por verdades ocultas.`,

8:`Intuição estratégica e poderosa. Capacidade de prever cenários, perceber forças invisíveis em jogos de poder e agir com precisão.`,
...
3:`Insights surgem em momentos criativos ou inspirados. Existe facilidade para perceber ideias novas, porém a intuição não é constante no dia a dia.`,

4:`Capacidade ocasional de prever consequências e perceber riscos. A intuição funciona melhor quando há planejamento e organização.`,

5:`Percepção intuitiva aparece diante de mudanças e oportunidades. Em períodos de movimento, a pessoa tende a confiar mais no próprio pressentimento.`,

6:`Intuição ligada ao cuidado e às relações próximas. Existe sensibilidade para perceber necessidades de pessoas queridas, ainda que nem sempre seja utilizada.`,

7:`Percepção interior aparece em momentos de introspecção. Quando há silêncio e reflexão, a intuição se torna mais evidente.`,

8:`Capacidade de perceber tendências e cenários surge em situações importantes, especialmente ligadas a trabalho e decisões práticas.`,
...
A intuição pode surgir apenas em momentos específicos, não sendo utilizada de forma constante no dia a dia. Desenvolver escuta interior, percepção sutil e confiança na própria intuição torna-se um aprendizado que pode ser construído gradualmente ao longo da vida.`,
1:`Existe pouca confiança na própria intuição. As decisões tendem a ser tomadas com base apenas na lógica ou na ação imediata, deixando de considerar percepções internas importantes.`,

2:`Sensibilidade intuitiva reduzida nas relações. Muitas vezes sinais emocionais ou energéticos passam despercebidos, o que pode gerar insegurança nos vínculos.`,

3:`A criatividade costuma depender mais de estímulos externos do que de inspiração interior. Insights espontâneos são raros.`,

4:`Predomínio da lógica e da segurança. A pessoa prefere seguir caminhos comprovados, mesmo quando a intuição sugere alternativas.`,

5:`Dificuldade em perceber sinais de mudança antes que eles aconteçam. A adaptação tende a ocorrer apenas depois que os fatos já se manifestaram.`,

6:`Sensibilidade intuitiva limitada no cuidado com pessoas próximas. A percepção das necessidades alheias costuma depender de sinais claros e objetivos.`,

7:`Conexão reduzida com a própria interioridade. Momentos de silêncio ou introspecção podem ser evitados ou pouco valorizados.`,

8:`Decisões importantes são baseadas quase exclusivamente em resultados concretos, deixando pouca abertura para percepções sutis.`,

9:`Dificuldade em perceber dimensões mais amplas da vida ou conexões humanas profundas. A visão tende a permanecer focada no imediato e no tangível.`
    }
  }
...
// --- CORREÇÃO FINAL: CONECTANDO O MAPA COMPLETO ---
if (typeof textosMapaCompleto !== 'undefined') {
    // Puxa os textos da gaveta certa que você criou (Linha 579)
    textos.dia = textosMapaCompleto.dia;
    textos.comportamento = textosMapaCompleto.comportamento;
    
    // Garante que o Mapa do Destino também enxergue esses textos
    textos.vida = textosMapaCompleto;
}
